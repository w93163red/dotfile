...
(setq user-full-name "Lingxiang Wang"
      user-mail-address "lingxiang.wang@bytedance.com")
...
(define-key evil-motion-state-map "L" 'move-end-of-line)
(define-key evil-motion-state-map "H" 'move-beginning-of-line)
